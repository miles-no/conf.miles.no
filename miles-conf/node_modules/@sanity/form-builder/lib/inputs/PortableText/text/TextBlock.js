...
function TextBlock(props) {
  ...
  var handleMouseOut = (0, _react.useCallback)(() => setReviewChangesHovered(false), []); // These are marker that is only for the block level (things further up, like annotations and inline objects are dealt with in their respective components)
