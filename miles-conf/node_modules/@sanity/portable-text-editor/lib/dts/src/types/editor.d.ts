...
export declare type EditorChange = BlurChange | ErrorChange | FocusChange | InvalidValue | LoadingChange | MutationChange | PatchChange | ReadyChange | RedoChange | SelectionChange | UndoChange | UnsetChange | ValueChange;
...
export declare type RenderBlockFunction = (value: PortableTextBlock, type: ObjectSchemaType, attributes: RenderAttributes, defaultRender: (val: PortableTextBlock) => JSX.Element, ref: React.RefObject<HTMLDivElement>) => JSX.Element;
export declare type RenderChildFunction = (value: PortableTextChild, type: ObjectSchemaType, attributes: RenderAttributes, defaultRender: (val: PortableTextChild) => JSX.Element, ref: React.RefObject<HTMLSpanElement>) => JSX.Element;
export declare type RenderAnnotationFunction = (value: PortableTextBlock, type: ObjectSchemaType, attributes: RenderAttributes, defaultRender: () => JSX.Element, ref: React.RefObject<HTMLSpanElement>) => JSX.Element;
...
export declare type ScrollSelectionIntoViewFunction = (editor: PortableTextEditor, domRange: globalThis.Range) => void;
